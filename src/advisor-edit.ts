...
const replaceEditSchema = Type.Object(
  {
    oldText: Type.String({
      description:
        "Exact text to replace. Must be unique in SUBDUDE.md and must not overlap with other edits[].oldText.",
    }),
...
> = {
  ...
  label: "advisor_edit",
  description:
    "Edit SUBDUDE.md using exact text replacement. Every edits[].oldText must match a unique, non-overlapping region of the original file. This is the only file you can edit.",
  promptSnippet: "Edit SUBDUDE.md to update your notes",
  promptGuidelines: [
    "Use advisor_edit to update sections of SUBDUDE.md with precise text replacements",
  ],
