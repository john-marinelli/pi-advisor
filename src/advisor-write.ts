...
const advisorWriteSchema = Type.Object({
  content: Type.String({ description: "Content to write to SUBDUDE.md" }),
});
...
export const advisorWriteTool: ToolDefinition<typeof advisorWriteSchema, undefined> = {
  ...
  label: "advisor_write",
  description:
    "Write content to SUBDUDE.md. Creates the file if it doesn't exist, overwrites if it does. This is the only file you can write to.",
  promptSnippet: "Write your findings and recommendations to SUBDUDE.md",
  promptGuidelines: [
    "Use advisor_write to create or overwrite SUBDUDE.md with your findings and recommendations",
  ],
